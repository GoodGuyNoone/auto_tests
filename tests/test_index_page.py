...
class TestButtons:
    ...
    def test_buttons_on_main_page(self, page):
        ...
        assert 'People' in header_buttons, 'Discover button is incorrect'
        assert 'Learning' in header_buttons, 'Discover button is incorrect'
        assert 'Jobs' in header_buttons, 'Discover button is incorrect'
